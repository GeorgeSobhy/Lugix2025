    ...
    public partial class AddIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropForeignKey(
                name: "FK_Games_ApplicationUser_UploaderId",
                table: "Games");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MainPageHeader = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MainGameId = table.Column<int>(type: "int", nullable: false),
                    ContactUsDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ContactUsAddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ContactUsPhone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ContactUsEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ContactUsMapUrl = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Settings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Settings_Games_MainGameId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TopCategories_Genres_CategoryId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Games_AspNetUsers_UploaderId",
                table: "Games",
                column: "UploaderId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
